...
\\
\>[B]{}\Varid{exp}\mathbin{::}\Conid{FeatureExpression},{}\<[E]%
\\
\>[B]{}\Varid{weavers}\mathbin{::}[\mskip1.5mu \Conid{Weaver}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\mskip1.5mu\}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{type}\;\Conid{Weaver}\mathrel{=}(\Conid{SPL}\to \Conid{SPLMember})\to \Conid{SPLMember}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{weavingProcess}\;\Varid{spl}\;\Varid{fm}\;\Varid{pc}\;\Varid{ck}\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{stepRefinement}\;[\mskip1.5mu (\Varid{w}\;\Varid{spl})\mid \Varid{w}\leftarrow \Varid{ws}\mskip1.5mu]\;\Varid{p}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\mathbf{where}{}\<[E]%
\\
\>[4]{}\hsindent{1}{}\<[5]%
\>[5]{}\Varid{ws}\mathrel{=}\Varid{concat}\;[\mskip1.5mu \Varid{weavers}\;\Varid{c}\mid \Varid{c}\leftarrow \Varid{ck},\Varid{eval}\;\Varid{pc}\;(\Varid{exp}\;\Varid{c})\mskip1.5mu]{}\<[E]%
\\
\>[4]{}\hsindent{1}{}\<[5]%
\>[5]{}\Varid{p}\mathrel{=}(\Varid{emptyInstance}\;\Varid{spl}\;\Varid{fc}){}\<[E]%
\\
\>[4]{}\hsindent{1}{}\<[5]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}(\longmapsto)\mathbin{::}\Varid{a}\to \Varid{b}\to (\Varid{a},\Varid{b})\mbox{\onelinecomment  just a 'syntactic sugar' to build pairs}{}\<[E]%
\\
\>[3]{}\Varid{l}\longmapsto\Varid{r}\mathrel{=}(\Varid{l},\Varid{r}){}\<[E]%
\\[\blanklineskip]%
\>[3]{}\Varid{conf1}\mathrel{=}\Conid{Configuration}\;(``\Varid{eShop''}\longmapsto\Varid{selectScenarios}\;[\mskip1.5mu ``\Conid{SC01''},``\Conid{SC02''}\mskip1.5mu]){}\<[E]%
\\
\>[3]{}\Varid{conf2}\mathrel{=}\Conid{Configuration}\;(\text{\tt 'Not'}\;(``\Conid{ShoppingCart''}\;\text{\tt 'And'}``\Conid{Bonus''})\longmapsto\Varid{evaluateAdvice}\;[\mskip1.5mu ``\Conid{ADV01''}\mskip1.5mu]){}\<[E]%
\\
\>[3]{}\Varid{conf3}\mathrel{=}\Conid{Configuration}\;(``\Conid{ShoppingCart''}\;\text{\tt 'And'}``\Conid{Bonus''}\longmapsto\Varid{evaluateAdvice}\;[\mskip1.5mu ``\Conid{ADV02''}\mskip1.5mu]){}\<[E]%
\\
\>[3]{}\Varid{conf4}\mathrel{=}\Conid{Configuration}\;(``\Conid{UpdateUserPreferences''}\longmapsto\Varid{evaluateAdvice}\;[\mskip1.5mu ``\Conid{ADV03''}\mskip1.5mu]){}\<[E]%
\\
\>[3]{}\Varid{conf5}\mathrel{=}\Conid{Configuration}\;(``\Conid{ShipMethod''}\longmapsto\Varid{bindParameter}\;(``\Conid{ShipMethod''},`\Conid{ShipMethod''})){}\<[E]%
\\
\>[3]{}\mathbin{...}{}\<[E]%
\\[\blanklineskip]%
\>[3]{}\Varid{ck}\mathrel{=}[\mskip1.5mu \Varid{conf1},\Varid{conf2},\Varid{conf3},\Varid{conf4},\Varid{conf5}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{pboxed}
\)\par\noindent\endgroup\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{traceModel}\;\Varid{s}\mathrel{=}\Varid{traces}\;(\Varid{steps}\;\Varid{s}){}\<[E]%
\\
\>[B]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{traces}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu [\mskip1.5mu \mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{traces}\;(\Varid{x}\mathbin{:}\Varid{xs})\mathrel{=}[\mskip1.5mu \mskip1.5mu]\mathbin{:}(\Varid{stepId}\;\Varid{x})\otimes(\Varid{traces}\;(\Varid{xs})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}(\otimes)\mathbin{::}(\Varid{a}\to [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu])\to [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{x}\otimes\Varid{y}\mathrel{=}[\mskip1.5mu \Varid{x}\mathbin{:}\Varid{e}\mid \Varid{e}\leftarrow \Varid{y}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{pboxed}
\)\par\noindent\endgroup\resethooks
...
summarized in Table~\ref{tab:mms-dos} and in Table~\ref{tab:mms-dof}.
...
studies~\cite{Conejero:2008aa,Morin:2008aa} in the area.
...
Even in this context, our approach also achieves some improvements in the
...
was modularized in a single scenario. The composition of \emph{error handling}
with the basic scenarios was done by means of annotations attributed to the
...
reduction of size does not compromise the requirement coverage; but actually it
...
Regarded to the modularization of
