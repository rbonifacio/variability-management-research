...
\emph{scenario} as  synonym for the textual specifications of use cases~\cite{Cockburn:2000aa}.
%-----------------------------------------------------------------------
...
review of the scenarios' \emph{Variation Points section}. This problem does not occur in the PLUSS notation. Moreover, due to the
...
a concrete flow of events. The \emph{match} function plays a
...
scenarios of a SPL.  Additionally, evolving a feature
with lower DoS requires localized changes. 
