...
\\
\>[B]{}\Varid{addScenarios}\;(\Varid{product},\Varid{scenarios}){}\<[E]%
\\
\>[B]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{scenarios}\mathrel{=}[\mskip1.5mu \Varid{s}\mid \Varid{s}\leftarrow (\Varid{splScenarios}\;\Varid{spl}),(id\;\Varid{s})\;\in\;\Varid{ids}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{addScenarios}\mathbin{...}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\Varid{matchedSteps}\mathrel{=}\Varid{match}\;(\Varid{product}\;(\Varid{pointCut}\;\Varid{advice})){}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\Varid{flow}\mathrel{=}\Varid{scenarioOfAdvice}\;(\Varid{advice}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\bibitem{Bachmann:2001aa}
F.~Bachmann and L.~Bass.
\newblock Managing variability in software architectures.
\newblock {\em SIGSOFT Softw. Eng. Notes}, 26(3):126--132, 2001.

\bibitem{Bertolino:2003aa}
...
\bibitem{Clements:2001aa}
P.~Clements and L.~Northrop.
\newblock {\em Software Product Lines: Practices and Patterns}.
\newblock {Addison-Wesley}, 2001.

\bibitem{Czarnecki:2000aa}
...
\bibitem{Jacobson:1997aa}
I.~Jacobson, M.~Griss, and P.~Jonsson.
\newblock {\em Software reuse: architecture, process and organization for
  business success}.
\newblock Addison-Wesley Publishing Co., 1997.

\bibitem{Jayaraman:2007aa}
P.~Jayaraman et~al.
\newblock {Model Composition in Product Lines and Feature Interaction Detection
  Using Critical Pair Analysis}.
\newblock {\em LNCS}, 4735:151--165, 2007.

\bibitem{Kastner:2008aa}
...
\bibitem{Krueger:2006aa}
C.~W. Krueger.
\newblock New methods in software product line practice.
\newblock {\em Commun. ACM}, 49(12):37--40, 2006.

\bibitem{Masuhara:2003aa}
