...
\end{center}
% 
% Next, after evaluating the fourth configuration, the result will be \ldots:
% 
% \begin{center}
% $Traces_{p} = {<>, <C1>, <C1, C2>, <C1,C2,P1>, <C1, C2,P1,P2>, <C1,C2P1, P2,
% P3>, <C1,C2P1, P2,P3,R1>, <S1>,<S1,S2>, <S1,S2,S3>, <S1,S2,S3,R1>}$
% \end{center}
% 
% 
% Finally\ldots.
% 
% \begin{center}
% $Traces_{p} = {<>, <C1>, <C1, C2>, <C1,C2,P1>, <C1, C2,P1,P2>, 
% <C1,C2P1, P2,P3>, <C1,C2P1, P2,P3,R1>, <S1>,<S1,S2>, <S1,S2,S3>, 
% <S1,S2,S3,R1>}$
% \end{center}
