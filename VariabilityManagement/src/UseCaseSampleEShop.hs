...
ucBuyProduct = UseCase "UC01" "Buy products use case" "This use case allows the user to buy producuts" [scBuyProductBasic, scBuyProductExtended] 
...
step3M = Step "3M" scBuyProductBasic "Fill in the requested information and select the proceed option" "-" "Request the shipping method and address" []
...
step5M = Step "5M" scBuyProductBasic "Confirm the purchase" "-" "Execute the order and send a request to the Delivery System to dispatch the products" ["UpdatePreferences"]
