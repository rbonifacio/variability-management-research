...
conf0 = Configuration exp0 [(addScenariosM2M ["1", "4"])]
--conf1 = (exp3, [scBuyProductBasic])
conf2 = Configuration exp1 [(addScenariosM2M ["2"])]
...
eShop1 = Feature "FEA-01" "eShop Instance" mandatory basicFeature [shoppingCart] []
