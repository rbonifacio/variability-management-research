...
\end{scriptsize}
\caption{Define policies for the the home state.}
\label{fig:defines-the-home-state-pluss}
\end{figure}
...
\end{scriptsize}
\caption{Defines the home state.}
\label{fig:defines-the-home-state-msvcm}
\end{figure}
...
\end{scriptsize}
\caption{Define rights for the inhabitants.}
\label{fig:defines-rights-msvcm}
\end{figure}

%
% MSVCM: Request access to Home scenario
%
\begin{figure}[htb]
\begin{scriptsize}
  \texttt{
  ...
  \begin{tabular}{|p{1in}|p{2.5in}|p{2.5in}|}
   \hline
       Step & User Action  & System Response \\ \hline \hline
       1 [RequestAccess] & & The system displays the message of success login.
       [AuthorizeAccess]\\ \hline 
       2 [RequestAccess] & & The system opens the front door and register the occurrence. \\ \hline 
       3 [RequestAccess] & & After SecondToClose seconds, the front door is closed. \\ \hline
  \end{tabular}
  \end{center}
  }
\end{scriptsize}
\caption{Request access to home scenario.}
\label{fig:request-access-to-home-msvcm}
\end{figure}
...
\begin{scriptsize}
  \texttt{
   \begin{tabular}{l}
   	 {\bf Advice ADV03} 	\\
     {\bf Description:} Request access to home with password\\
     {\bf Before: AuthorizeAccess} \\
   \end{tabular}
  \begin{center}
  \begin{tabular}{|p{1.2in}|p{2.3in}|p{2.5in}|}
   \hline
       Step & User Action  & System Response \\ \hline
       1a [RequestAccess] [Password]	& 
       The inhabitant request access to the home at the main entrance. & The
       system requests to the user to pass the smart card. \\ \hline
       2 [RequestAccess] [Password] & 
       The inhabitant pass the smart card in the card reader. & The system
       requests to the user the password to access the smart home. \\ \hline 
       3 [RequestAccess] [Password]& The inhabitant informs the access password.  & 
       The system verifies that the password is valid for the registered
       inhabitant. \\ \hline       
  \end{tabular}
  \end{center}
...
\end{scriptsize}
\caption{Request access to home with password advice.}
\label{fig:request-access-password-msvcm}
\end{figure}
...
\begin{scriptsize}
  \texttt{
   \begin{tabular}{l}
   	 {\bf Advice ADV03} 	\\
     {\bf Description:} Request access to home with fingerprint\\
     {\bf Before: AuthorizeAccess} \\
   \end{tabular}
  \begin{center}
  \begin{tabular}{|p{1.2in}|p{2.3in}|p{2.5in}|}
...
\end{scriptsize}
\caption{Request access to home with fingerprint advice.}
\label{fig:request-access-fingerprint-msvcm}
\end{figure}
