...
xmlAdvice2Advice xmlAdvice = 
 let 
  flow = [xmlStep2Step s | s <- xmlAdviceSteps (xmlAdvice)]
...
xmlStep2Step (XmlStep i a s r) = Step i a s r []
...
--| the reverse function for converting a 
-- use case model into a xml use case model
