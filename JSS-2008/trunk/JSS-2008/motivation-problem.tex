...
We can represent these kind of dependencies by means of Design Structure
...
whenever a design decision depends on another. Figure~\ref{dsm:hw01}
...
3 & Architectural decisions		& 	x 	& 		& 		&   & 	\\
4 & Complaint implementation	& 	x	&		&	x	&	& x	\\
5 & Auditing AO implementation	& 		&	x	&		& x	&	\\\hline
\end{tabular}
\end{small}
